...
def send_default_actions(session):
    ...
    session.hardware_expect('commit', CONFIG_MODE_PROMPT)
    session.hardware_expect('', CONFIG_MODE_PROMPT)
...
SUPPORTED_OS = ['IOS-XR', 'IOS XR', 'IOSXR']
...
CONFIGURATION_OPERATIONS_CLASS = CiscoIOSXRConfigurationOperations
FIRMWARE_OPERATIONS_CLASS = CiscoIOSXRConfigurationOperations
